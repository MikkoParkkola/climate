                      ...
                      <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                        ...
                        <div className="space-y-3">
                          {(() => {
                            ...
                            return challenges.slice(0, 4).map((challenge, index) => (
                              <div key={index} className="border-l-4 border-red-400 pl-3">
                                <div className="flex items-center gap-2 mb-1">
                                  <span className="font-medium text-red-800 text-sm">{challenge.issue}</span>
                                  <Badge 
                                ...
                                <p className="text-xs text-red-700 mb-1">{challenge.description}</p>
                                <p className="text-xs text-red-600 font-medium">Impact: {challenge.magnitude}</p>
                              </div>
                            ));
                          })()}
                        </div>
