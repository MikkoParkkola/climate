                        ...
                        return (
                          <>
                            ...
                            <div className="absolute top-1 right-4 text-xs">
                              <div className="flex items-center gap-2 bg-white/90 p-2 rounded border">
                                <div className="flex items-center gap-1">
                                  <div className="w-4 h-0.5 bg-red-600"></div>
                                  <span className="text-red-600">{climateData.year} Projection</span>
                                </div>
                                <div className="bg-red-50 px-2 py-1 rounded text-red-700 font-medium">
                                  {tempChange > 0 ? '+' : ''}{tempChange?.toFixed(1)}°C vs baseline
                                </div>
                              </div>
                            </div>
                      ...
                      <div className="absolute top-0 right-0 text-xs mb-2">
                        <div className="flex items-center gap-2 bg-white/90 p-2 rounded border">
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-blue-600">{climateData.year} Projection</span>
                          </div>
                          <div className="bg-blue-50 px-2 py-1 rounded text-blue-700 font-medium">
                            {(climateData.precipitation_change || 0) > 0 ? '+' : ''}{(climateData.precipitation_change || 0)?.toFixed(1)}% vs baseline
                          </div>
                        </div>
                      </div>
                        ...
                        {climateData.precipitation?.monthly?.map((precip: number, index: number) => {
                          ...
                          return (
                            <div key={index} className="text-center flex flex-col justify-end h-full relative">
                              {/* Precipitation bar */}
                              <div className="flex items-end justify-center mb-8 h-24">
                                <div 
