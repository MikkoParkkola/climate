                                ...
                                {['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'].map((month, index) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      ...
                                      <div className={`font-mono text-xs ${difference > 0 ? 'text-red-500' : difference < 0 ? 'text-blue-500' : 'text-gray-500'}`}>
                        ...
                        {climateData.precipitation?.monthly?.map((precip: number, index: number) => {
                          ...
                          return (
                            <div key={index} className="text-center flex flex-col justify-end h-full relative">
                              {/* Baseline bar (behind) */}
                              <div 
                                className="bg-gray-400 rounded-t w-full absolute bottom-12 opacity-60"
                                style={{ height: `${baselineHeight}px` }}
                                title={`${months[index]} Baseline: ${baselinePrecip.toFixed(1)}mm`}
                              ></div>
                              
                              {/* Projected bar (in front) */}
                              <div 
                                className="bg-gradient-to-t from-blue-600 to-blue-300 rounded-t w-full mb-12 relative z-10 opacity-90"
                              ...
                              <div className="text-xs font-mono text-gray-500">{baselinePrecip.toFixed(0)}mm</div>
                              <div className="text-xs font-mono text-blue-700 font-bold">{precip.toFixed(0)}mm</div>
                              <div className={`text-xs font-mono ${difference > 0 ? 'text-green-600' : difference < 0 ? 'text-orange-600' : 'text-gray-500'}`}>
