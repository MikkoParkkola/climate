        ...
        <Card className="bg-[hsl(222,15%,12%)] text-white">
          <CardContent className="prose prose-sm prose-invert max-w-none pt-6">
            ...
            <ul>
              ...
              <li>
                <strong>Crop yields</strong>: ISIMIP GGCMI phase 3 ensemble-mean change in
                rainfed yield of maize, soybean, rice and winter wheat for the surrounding
                0.5° cell at 2030, 2050 and 2080, versus a 2015-2034 baseline. SSP1-2.6,
            ...
            <h2>Crop yields</h2>
            <p>
              The crop field is ISIMIP3b GGCMI phase 3 output for four staple crops (maize,
              soybean, rice and winter wheat). We use the rainfed, default-CO2 runs and take
              the multi-member ensemble mean (GCMs averaged within a crop model, then crop
              models averaged) of the percentage change in annual yield at 2030, 2050 and
              2080 relative to a 2015-2034 baseline, on the native 0.5° grid. SSP1-2.6,
              SSP3-7.0 and SSP5-8.5 are covered directly; SSP2-4.5 is not in the GGCMI3b core
              protocol and is left blank rather than approximated. This is a model-ensemble
              crop signal, not a field-level or farm-level forecast: it holds 2015 land use
              and management fixed, assumes rainfed conditions with default CO2 fertilization
              (whose real-world strength is uncertain), and does not represent adaptation, new
            ...
            <p className="text-slate-400">
              ...
              maps (Ward et al. 2020); ISIMIP3b GGCMI phase 3 crop-yield projections
              (Jagermeyr et al. 2021, CC0 1.0); Climate Action Tracker thermometer; Hausfather &amp; Peters
