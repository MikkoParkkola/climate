...
- Remove stale merge artifacts, dead code, misleading docs, old private notes, generated logs, and scratch files that make the project look careless.
- Ensure `README.md`, `/methodology`, `docs/architecture/*`, `LICENSE`, `SECURITY.md`, and contribution notes are coherent and public-facing.
...
### R10. Viral, awareness, and highlight layer
...
- No public route serves ungrounded projections.
