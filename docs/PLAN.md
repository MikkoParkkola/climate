...
4. Capture desktop/mobile screenshots for home, single-location, comparison, rankings, methodology, and data-quality. Do not run a full browser e2e over the real model; verify in layers.
